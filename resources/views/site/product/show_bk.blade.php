                                    ...
                                    <div class="tf-product-info-help">
                                        ...
                                        {{-- <div class="tf-product-info-time">
                                            ...
                                            <p class="text-caption-1">
                                                Estimated Delivery:
                                                <span>{{ $productInfo['estimated_delivery']['international'] }}</span>
                                                (International),
                                                <span>{{ $productInfo['estimated_delivery']['us'] }}</span> (United States)
                                            </p>
                                        </div>
                                        ...
                                        <div class="tf-product-info-return">
                                            ...
                                            <p class="text-caption-1">
                                                Return within <span>{{ $productInfo['return_days'] }}</span> days of
