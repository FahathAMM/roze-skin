                   ...
                   <div class="wrap-recommendations">
                       <div class="list-cart">
                           ...
                           {{-- <div class="list-cart-item">
                               ...
                               <div class="content">
                                   <div class="name">
                                       <a class="link text-line-clamp-1" href="product-detail.html">Double-button
                                           coat</a>
                                   </div>
                                   <div class="cart-item-bot">
                                       <div class="text-button price">$59.99</div>
                           ...
                           <div class="list-cart-item">
                               ...
                               <div class="content">
                                   <div class="name">
                                       <a class="link text-line-clamp-1" href="product-detail.html">Belted Manteco
                                           coat</a>
                                   </div>
                                   <div class="cart-item-bot">
                                       <div class="text-button price">$59.99</div>
                           ...
                           <div class="list-cart-item">
                               <div class="image">
                                   <img class="lazyload" data-src="images/products/womens/women-5.jpg"
                                       src="images/products/womens/women-5.jpg" alt="">
                               </div>
                               <div class="content">
                                   <div class="name">
                                       <a class="link text-line-clamp-1" href="product-detail.html">Belt wrap dress</a>
                           ...
                           <div class="list-cart-item">
                               <div class="image">
                                   <img class="lazyload" data-src="images/products/womens/women-6.jpg"
                                       src="images/products/womens/women-6.jpg" alt="">
                               </div>
                               <div class="content">
                                   <div class="name">
                                       <a class="link text-line-clamp-1" href="product-detail.html">Belt wrap dress</a>
                                   ...
                                   <div class="tf-mini-cart-view-checkout">
                                       <a href="shopping-cart.html"
                                           class="tf-btn w-100 btn-white radius-4 has-border"><span
                                               class="text">View
                                               cart</span></a>
                                       <a href="shopping-cart.html" class="tf-btn w-100 btn-fill radius-4"><span
                                               class="text">Check Out</span></a>
                                   </div>
                                   <div class="text-center">
                                       <a class="link text-btn-uppercase" href="shop-default-grid.html">Or continue
                                           shopping</a>
                                   </div>
                               </div>
                           </div>
                               ...
                               <div class="tf-mini-cart-tool-content">
                                   ...
                                   <form class="form-estimate-shipping tf-mini-cart-tool-wrap">
                                       ...
                                       <fieldset class="">
                                           ...
                                           <input class="" type="text" placeholder="100000" name="text"
