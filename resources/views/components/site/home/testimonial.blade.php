                 ...
                 @foreach ($testimonials as $item)
                     <div class="swiper-slide">
                         <div class="testimonial-item hover-img">
                             <div class="img-style">
                                 <img data-src="{{ asset('sites/images/testimonial/tes-3.jpg') }}"
                                     src="{{ asset('sites/images/testimonial/tes-3.jpg') }}" alt="img-testimonial">
                             ...
                             <div class="content">
                                 ...
                                 <div class="box-avt">
                                     ...
                                     <div class="box-price">
                                         ...
                                         <div class="text-button price">AED {{ $item['price'] ?? '' }}</div>
                                     </div>
                                 </div>
                             </div>
                         </div>
