            ...
            <form id="product-form" method="POST" action="{{ route('products.update', ['product' => $product->id]) }}"
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            <x-input.txt-group label="Stock (QTY)" name="quantity"
                                                placeholder="Enter your Stock" value="{{ $product->quantity ?? '' }}" />
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="product-price-input">Simple Original
                                                price</label>
                                            <div class="input-group has-validation mb-3">
                                                <span class="input-group-text" id="product-price-addon">$</span>
                                                <input type="text" class="form-control" id="simple_original_price"
                                                    placeholder="Enter Original price" name="simple_original_price"
                                                    aria-describedby="product-price-addon"
                                                    value="{{ $product->simple_original_price ?? '' }}">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="product-price-input">Simple Sale
                                                price</label>
                                            <div class="input-group has-validation mb-3">
                                                <span class="input-group-text" id="product-price-addon">$</span>
                                                <input type="text" class="form-control" id="simple_sale_price"
                                                    placeholder="Enter Original price" name="simple_sale_price"
                                                    aria-describedby="product-price-addon"value="{{ $product->simple_sale_price ?? '' }}">
                                                <div class="invalid-feedback">Please Enter a product price.</div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="card mb-1">
                            <div class="card-header">
                                <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#addproduct-price-variant"
                                            role="tab" aria-selected="true">
                                            Product Attributes
                                        </a>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <a class="nav-link" data-bs-toggle="tab" href="#addproduct-general-info"
                                            role="tab" aria-selected="true">
                                            Product Attributes
                                        </a>
                                    </li>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    <div class="tab-pane active show" id="addproduct-price-variant" role="tabpanel">
                                        <div class="table-responsivew">
                                            <p class="text-muted">
                                                <button type="button"
                                                    class="float-end add-variant-row btn mb-2 fw-medium btn-soft-secondary">
                                                    ...
                                                    @foreach ($product->variants as $variant)
                                                        <tr id="1" class="product">
                                                            <td class="text-start py-0 w-25">
                                                                <div class="mb-0">
                                                                    <x-input.txt-group name="variant_type[]"
                                                                        placeholder="Variant Type" :value="$variant->type" />
                                                                </div>
                                                            </td>
                                                            <td class="text-start py-0">
                                                                <div class="mb-0">
                                                                    <x-input.txt-group name="variant_quantity[]"
                                                                        placeholder="QTY" :value="$variant->quantity" />
                                                                </div>
                                                            </td>
                                                            <td class="py-0">
                                                                <div>
                                                                    <x-input.txt-group name="variant_original_price[]"
                                                                        placeholder="Original Price" :value="$variant->original_price" />
                                                                </div>
                                                            </td>
                                                            <td class="py-0">
                                                                <div>
                                                                    <x-input.txt-group name="variant_sale_price[]"
                                                                        placeholder="Sale Price" :value="$variant->sale_price" />
                                                                </div>
                                                            </td>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card mb-1">
                            <div class="card-header">
                                <h5 class="card-title mb-0">Product Hot Description</h5>
                            </div>
                            <div class="card-body">
                                <div class="hstack gap-3 align-items-start">
                                    <div class="flex-grow-1">
                                        <x-input.txt-group label="Display Description" name="display_disc"
                                            placeholder="Hot Sale 25% OFF" value="{{ $product->display_disc ?? '' }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
